...
type LockStore interface {
	...
	Claim(ctx context.Context, pool string, slots int, holder string, ttl time.Duration) (*Claim, error)
	...
	Status(ctx context.Context, pool string, slots int) ([]SlotStatus, error)
